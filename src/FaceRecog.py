...
class FaceRecog():
    ...
    def __init__(self, haarcascade_capture, haarcascade_recognize, trainer_file, data_path):
        ...
        while True:
            ...
            for (x,y,w,h) in faces:
                ...
                if (confidence < 100):
                    ...
                    cv2.putText(img, str(names[user_id-1]), (x+5,y-5), font, 1, (255,255,255), 2)
                else:
    ...
    def train(self):
        faces, ids = getImagesAndLabels(self.data_path)
